...
| #   | Feature                        | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| --- | ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | **Course Linker / Course Map** | Deterministic semester-column prerequisite map with static layout, prerequisite/downstream inspection, accepted and pending relations, cycle and missing-record reporting, earliest eligible semester, local cumulative move simulation, ordered undo/reset, URL sharing, saved scenarios, optimistic revisions, stale-reference replay, and persistence of move intent only. No freeform editor, arbitrary placement, automatic rescheduling, or AI recommendations yet. |
...
| 4   | **Course Intelligence Brief**  | Evidence-first course research with bounded category searches, citation-validated official/professor/RMP sources, DeepSeek V4 Pro synthesis, contradiction and missing-evidence reporting, auditable usage/cost, and cancellation-safe cached jobs.                                                                                                                                                                                                                       |
...
| 4   | **Database Infrastructure**      | Drizzle ORM setup, migrations system, Neon connection, shared DB utilities, CI/CD DB provisioning.                                                                                                                       |
...
4. **AI feature code** (Demi's scope) includes: prompt templates, LLM integration, extraction/query pipelines, and grade calculation logic, except for the complete Exam Prep (RAG) feature, which is owned by Ekas. Do not touch.
...
6. **Database schemas are per-feature.** Each person owns the Drizzle table definitions, migrations, and seed data for their own features. Demi owns the shared DB infrastructure (connection, migration runner, Neon config).
